      ...
      builder: (context, snap) {
        if (!snap.hasData || snap.data!.isEmpty) {
          return Container(
            ...
            child: const Text('Bannerlar yoq', style: TextStyle(color: AppColors.textSecondary)),
          );
        }
        ...
        SizedBox(
          ...
          child: StreamBuilder<List<MovieModel>>(
            ...
            builder: (context, snap) {
              ...
              final movies = snap.data!;
              if (movies.isEmpty) {
                return const Center(child: Text('Hozircha kino yoq', style: TextStyle(color: AppColors.textSecondary)));
              }
              return ListView.separated(
                scrollDirection: Axis.horizontal,
                padding: const EdgeInsets.symmetric(horizontal: 16),
